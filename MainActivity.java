package com.example.espejosimple;
...
public class MainActivity extends AppCompatActivity {
    ...
    android.view.TextureView.SurfaceTextureListener textureListener;
    ...
    android.view.TextureView.SurfaceTextureListener surfaceTextureListener = new TextureView.SurfaceTextureListener() {
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "For close the mirror just go back", Toast.LENGTH_LONG).show();
    ...
    public void Brigthness() {

        WindowManager.LayoutParams lp = getWindow().getAttributes();
        lp.screenBrightness = 0.65f;
